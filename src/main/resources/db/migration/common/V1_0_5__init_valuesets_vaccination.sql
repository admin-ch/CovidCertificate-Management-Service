do $$
    ...
    begin
        ...
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'EU/1/20/1528', 'Comirnaty', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'EU/1/20/1507', 'Spikevax (previously COVID-19 Vaccine Moderna)', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'EU/1/21/1529', 'Vaxzevria', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'EU/1/20/1525', 'COVID-19 Vaccine Janssen', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'CVnCoV', 'CVnCoV', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'Sputnik-V', 'Sputnik-V', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'Convidecia', 'Convidecia', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'EpiVacCorona', 'EpiVacCorona', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'BBIBP-CorV', 'BBIBP-CorV', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'Inactivated-SARS-CoV-2-Vero-Cell', 'Inactivated SARS-CoV-2 (Vero Cell)', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'CoronaVac', 'CoronaVac', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'Covaxin', 'Covaxin (also known as BBV152 A, B, C)', TODO, TODO, true);
        insert into vaccines_covid_19_names values (gen_random_uuid (), 'Covishield', 'Covishield (ChAdOx1_nCoV-19)', TODO, TODO, true);
