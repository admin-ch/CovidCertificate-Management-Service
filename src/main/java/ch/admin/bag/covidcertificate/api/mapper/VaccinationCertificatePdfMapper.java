...
public class VaccinationCertificatePdfMapper {
    ...
    public static VaccinationCertificatePdf toVaccinationCertificatePdf(
        ...
        return new VaccinationCertificatePdf(
                ...
                vaccinationCertificateCreateDto.getCertificateData().get(0).getNumberOfDoses(),
                vaccinationCertificateCreateDto.getCertificateData().get(0).getTotalNumberOfDoses(),
                vaccinationCertificateCreateDto.getCertificateData().get(0).getVaccinationDate(),
