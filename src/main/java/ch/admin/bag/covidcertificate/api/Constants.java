...
public class Constants {
    ...
    public static final CreateCertificateError INVALID_ADDRESS = new CreateCertificateError(471, "Paper-based delivery requires a valid address.", HttpStatus.BAD_REQUEST);
