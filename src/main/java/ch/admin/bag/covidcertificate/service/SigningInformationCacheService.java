...
public class SigningInformationCacheService {
    ...
    public List<SigningInformation> findSigningInformation(String certificateType){
        log.info("Loading signing information for {} certificate", certificateType);
        return signingInformationRepository.findSigningInformation(certificateType);
    }

    @Cacheable(SIGNING_INFORMATION_CACHE)
    public SigningInformation findSigningInformation(String certificateType, String code){
        log.info("Loading signing information for {} certificate with code {}", certificateType, code);
        return signingInformationRepository.findSigningInformation(certificateType, code);
    }
